...
const formScheme = z.object({
    name: z.string()
        .min(1, { message: "Numele este necesar" })
        .max(50, { message: "Maxim 50 de caractere" })
        .refine((value) => !pattern.test(value), { message: `Nu pot exista caracterele soeciale: ${pattern}` }),

    message: z.string()
        .min(1, { message: "Mesajul este necesar" })
        .max(200, { message: "Maxim 200 de caractere" })
})
