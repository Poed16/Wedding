    ...
    return (
        <section className="container-box2 mt-24 md:mt-betweenSectionMd xl:mt-betweenSection py-14 xl:py-20">
            <motion.div
                ...
                {...anim(bluryEffect)}
            >
                <h2 className="heading-4 md:heading-3 xl:heading-2 font-dancing-script">Cartea invitatilor</h2>
                <p className="text-xs md:text-base font-roboto-slab">Prezenta voastra ne va face ziua mai buna, cuvintele vor ramane pentru totdeauna</p>
            </motion.div>
